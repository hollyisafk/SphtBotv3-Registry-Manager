    ...
    public partial class frmMain : Form
    {
        ...
        private void Read()
        {
            ...
            try
            {
                    ...
                    cboIgnoreUTF.Text = Convert.ToString((Int32)regKey.GetValue("Ignore UTF8", 0)) == "1" ? "Enabled" : "Disabled";
        ...
        private void Write()
        {
            ...
            try
            {
                ...
                SetAbled(regKey, cboIgnoreUTF, "Ignore UTF8", RegistryValueKind.DWord);
