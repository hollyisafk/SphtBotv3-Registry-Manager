...
namespace SphtBotv3_Registry_Manager
{
    public partial class frmMain : Form
    {
        ...
        private void frmMain_Load(object sender, EventArgs e)
        {
            ...
            if (regKey.GetValue("Ignore Plugin Mask") == System.String.Empty) regKey.SetValue("Ignore Plugin Mask", System.String.Empty, RegistryValueKind.String);
            if (regKey.GetValue("Realm Character") == System.String.Empty) regKey.SetValue("Realm Character", System.String.Empty, RegistryValueKind.String);
            if (regKey.GetValue("Realm Name") == System.String.Empty) regKey.SetValue("Realm Name", System.String.Empty, RegistryValueKind.String);
